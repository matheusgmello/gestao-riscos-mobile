...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework.authtoken', # tabela legada, não usada — autenticação é via JWT (ver SIMPLE_JWT)
    'corsheaders',
    'usuarios',
    'riscos',
]
...
# JWT de acesso único e vida longa — sem refresh (não exigido pela disciplina).
# O token nunca é revogado no servidor; "logout" é só limpar o storage no app.
SIMPLE_JWT = {
